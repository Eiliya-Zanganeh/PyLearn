...
plt.figure()
plt.plot(train_result.history['loss'], label='train loss')
plt.plot(train_result.history['val_loss'], label='validation loss')
plt.legend()
...
plt.figure()
plt.plot(train_result.history['accuracy'], label='train accuracy')
plt.plot(train_result.history['val_accuracy'], label='validation accuracy')
plt.legend()
