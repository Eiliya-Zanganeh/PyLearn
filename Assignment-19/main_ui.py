...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(443, 411)
        MainWindow.setStyleSheet(u"background-color: #4CCD99;")
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.gridLayout = QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName(u"gridLayout")
        self.btn_13 = QToolButton(self.centralwidget)
        ...
        self.btn_1.setStyleSheet(u"background-color: #007F73;")
        ...
        self.btn_3.setStyleSheet(u"background-color: #007F73;")

        self.gridLayout.addWidget(self.btn_3, 0, 2, 1, 1)

        self.btn_15 = QToolButton(self.centralwidget)
        ...
        self.btn_15.setStyleSheet(u"background-color: #007F73;")

        self.gridLayout.addWidget(self.btn_15, 3, 2, 1, 1)

        self.btn_5 = QToolButton(self.centralwidget)
        self.btn_5.setObjectName(u"btn_5")
        sizePolicy.setHeightForWidth(self.btn_5.sizePolicy().hasHeightForWidth())
        self.btn_5.setSizePolicy(sizePolicy)
        self.btn_5.setStyleSheet(u"background-color: #007F73;")

        self.gridLayout.addWidget(self.btn_5, 1, 0, 1, 1)

        self.btn_14 = QToolButton(self.centralwidget)
        ...
        self.btn_10.setStyleSheet(u"background-color: #007F73;")

        self.gridLayout.addWidget(self.btn_10, 2, 1, 1, 1)

        self.btn_12 = QToolButton(self.centralwidget)
        ...
        self.btn_16.setStyleSheet(u"background-color: #007F73;")
        ...
        self.btn_4.setStyleSheet(u"background-color: #007F73;")

        self.gridLayout.addWidget(self.btn_4, 0, 3, 1, 1)

        self.btn_11 = QToolButton(self.centralwidget)
        ...
        self.btn_11.setStyleSheet(u"background-color: #007F73;")
