...
def main():
    ...
    potato = cv.imread('potato.png')
    apple = cv.imread('apple.png')
    orange = cv.imread('orange.png')
    face_effect_potato = FaceEffect(potato, (130, 120), (80, 70), (160, 62))
    face_effect_apple = FaceEffect(apple, (130, 120), (80, 70), (160, 62))
    face_effect_orange = FaceEffect(orange, (130, 120), (80, 70), (160, 62))
    ...
    while True:
        ...
        potato_frame = face_effect_potato.get_lips_and_eyes(frame, draw_lips=True, draw_eyes=True)
        apple_frame = face_effect_apple.get_lips_and_eyes(frame, draw_lips=True, draw_eyes=True)
        orange_frame = face_effect_orange.get_lips_and_eyes(frame, draw_lips=True, draw_eyes=True)

        cv.imshow('potato', potato_frame)
        cv.imshow('apple', apple_frame)
        cv.imshow('orange', orange_frame)
